    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "filing_id",
                    models.IntegerField(
                        help_text="Unique identification number for the Form 461 filing (from CVR_CAMPAIGN_DISCLOSURE_CD.FILING_ID)",
                        primary_key=True,
                        serialize=False,
                ...
                (
                    ...
                    models.IntegerField(
                        db_index=True,
                        help_text="Number of amendments to the Form 461 filing (from maximum value of CVR_CAMPAIGN_DISCLOSURE_CD.AMEND_ID)",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "amend_id",
                    models.IntegerField(
                        help_text="Identifies the version of the Form 461 filing, with 0 representing the initial filing (from CVR_CAMPAIGN_DISCLOSURE_CD.AMEND_ID)",
        ...
        migrations.AlterField(
            ...
            field=models.IntegerField(
                help_text="Identifies the version of the Form 460 filing, with 0 representing the initial filing (from CVR_CAMPAIGN_DISCLOSURE_CD.AMEND_ID)",
                verbose_name="amendment id",
            ),
        ),
