        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        db_index=True,
                        help_text="Line number of the filing form where the transaction is itemized (from S496_CD.LINE_ITEM)",
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        help_text="Amount paid to the payee in the period covered by the filing (from S496_CD.AMOUNT)",
                        max_digits=14,
                        verbose_name="amount",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        db_index=True,
                        help_text="Identifies a unique transaction across versions of the a given Schedule 496 filing (from S496_CD.TRAN_ID)",
                        max_length=20,
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Reference number for the memo attached to the transaction (from S496_CD.MEMO_REFNO)",
                        max_length=20,
