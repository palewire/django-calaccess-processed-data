INSERT INTO calaccess_processed_filings_form460scheduleiitem (
    filing_id,
    line_item,
    date_received,
    date_received_thru,
...
SELECT
    ...
    item_version.amount,
    item_version.receipt_description,
...
JOIN calaccess_processed_filings_form460scheduleiitemversion item_version
