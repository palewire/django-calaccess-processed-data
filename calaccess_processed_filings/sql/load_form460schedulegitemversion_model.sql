INSERT INTO calaccess_processed_filings_form460schedulegitemversion (
    filing_version_id,
    line_item,
    agent_title,
    agent_lastname,
...
SELECT
    ...
    UPPER(expn."AGENT_NAMT") AS agent_title,
    UPPER(expn."AGENT_NAML") AS agent_lastname,
    UPPER(expn."AGENT_NAMF") AS agent_firstname,
    UPPER(expn."AGENT_NAMS") AS agent_name_suffix,
    CASE
    ...
    expn."G_FROM_E_F" AS parent_schedule,
