...
class ScrapedCandidatElectioneNameParsingTest(TestCase):
    ...
    def test_parse_of_state_senate_special_election_name(self):
        ...
        parsed_name = ScrapedCandidateElectionProxy(
            name="2009 SPECIAL ELECTION (STATE SENATE 26)"
        ).parsed_name
        assert parsed_name == {
            "year": 2009,
    ...
    def test_parse_of_assembly_special_runoff_name(self):
        ...
        parsed_name = ScrapedCandidateElectionProxy(
            name="2010 SPECIAL RUNOFF (ASSEMBLY 72)"
        ).parsed_name
        assert parsed_name == {
            "year": 2010,
            "type": "SPECIAL RUNOFF",
    ...
    def test_parse_of_special_election_name_without_district(self):
        ...
        parsed_name = ScrapedCandidateElectionProxy(
            name="2003 SPECIAL ELECTION (GOVERNOR)"
        ).parsed_name
        assert parsed_name == {
            "year": 2003,
            "type": "SPECIAL ELECTION",
