# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-08 17:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classification', models.CharField(choices=[('committee-meeting', 'Committee Meeting'), ('election', 'Election'), ('hearing', 'Hearing')], help_text='Classification of the event.', max_length=300)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filing', models.ForeignKey(db_constraint=False, help_text='Unique identification number for the Schedule 497 filing (from S497_CD.FILING_ID)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='versions', to='calaccess_processed.Form497Filing')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filing', models.ForeignKey(help_text='Unique identification number for the Schedule 497 filing (from S497_CD.FILING_ID)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contributions_received', to='calaccess_processed.Form497Filing')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contributor_occupation', models.CharField(blank=True, help_text='Occupation of the contributor (from S497_CD.CTRIB_OCC)', max_length=60, verbose_name='contributor occupation')),
                ('contributor_is_self_employed', models.BooleanField(default=False, help_text='Indicates whether or not the contributor is self-employed(from S497_CD.CTRIB_SELF)', verbose_name='contributor is self employed')),
                ('filing_version', models.ForeignKey(help_text='Foreign key referring to the version of the Schedule 497 that includes the received contribution', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contributions_received', to='calaccess_processed.Form497FilingVersion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filing', models.ForeignKey(db_constraint=False, help_text='Unique identification number for the Schedule 497 filing (from S497_CD.FILING_ID)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contributions_made', to='calaccess_processed.Form497Filing')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('support_opposition_code', models.CharField(blank=True, choices=[('O', 'Opposition'), ('S', 'Support')], help_text='Code describing whether the contribuitor supports or opposesthe candidate or ballot measure (from S497_CD.SUP_OPP_CD)', max_length=1, verbose_name='support opposition code')),
                ('election_date', models.DateField(help_text='Date of the election (from S497_CD.ELEC_DATE)', null=True, verbose_name='election date')),
                ('filing_version', models.ForeignKey(help_text='Foreign key referring to the version of the Schedule 497 that includes the given contribution', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='contributions_made', to='calaccess_processed.Form497FilingVersion')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Time that this object was last updated in the system.')),
                ('extras', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, help_text='Common to all Open Civic Data types, the value is a key-value store suitable for storing arbitrary information not covered elsewhere.')),
                ('id', calaccess_processed.models.opencivicdata.base.OCDIDField(ocd_type='jurisdiction', serialize=False, validators=[django.core.validators.RegexValidator(flags=32, message='ID must match ^ocd-jurisdiction/country:[a-z]{2}(/[^\\W\\d]+:[\\w.~-]+)*/\\w+$', regex='^ocd-jurisdiction/country:[a-z]{2}(/[^\\W\\d]+:[\\w.~-]+)*/\\w+$')])),
                ('name', models.CharField(max_length=300)),
                ('url', models.URLField(max_length=2000)),
                ('classification', models.CharField(choices=[('government', 'Government'), ('legislature', 'Legislature'), ('executive', 'Executive'), ('school_system', 'School System'), ('transit_authority', 'Transit Authority')], db_index=True, default='government', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Time that this object was last updated in the system.')),
                ('extras', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, help_text='Common to all Open Civic Data types, the value is a key-value store suitable for storing arbitrary information not covered elsewhere.')),
                ('id', calaccess_processed.models.opencivicdata.base.OCDIDField(ocd_type='membership', serialize=False, validators=[django.core.validators.RegexValidator(flags=32, message='ID must match ^ocd-membership/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$', regex='^ocd-membership/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Time that this object was last updated in the system.')),
                ('extras', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, help_text='Common to all Open Civic Data types, the value is a key-value store suitable for storing arbitrary information not covered elsewhere.')),
                ('id', calaccess_processed.models.opencivicdata.base.OCDIDField(ocd_type='organization', serialize=False, validators=[django.core.validators.RegexValidator(flags=32, message='ID must match ^ocd-organization/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$', regex='^ocd-organization/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$')])),
                ('name', models.CharField(max_length=300)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Time that this object was last updated in the system.')),
                ('extras', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, help_text='Common to all Open Civic Data types, the value is a key-value store suitable for storing arbitrary information not covered elsewhere.')),
                ('id', calaccess_processed.models.opencivicdata.base.OCDIDField(ocd_type='person', serialize=False, validators=[django.core.validators.RegexValidator(flags=32, message='ID must match ^ocd-person/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$', regex='^ocd-person/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Time that this object was last updated in the system.')),
                ('extras', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, help_text='Common to all Open Civic Data types, the value is a key-value store suitable for storing arbitrary information not covered elsewhere.')),
                ('id', calaccess_processed.models.opencivicdata.base.OCDIDField(ocd_type='post', serialize=False, validators=[django.core.validators.RegexValidator(flags=32, message='ID must match ^ocd-post/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$', regex='^ocd-post/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('contestbase_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='calaccess_processed.ContestBase')),
            ...
            bases=('calaccess_processed.contestbase',),
        ),
        migrations.CreateModel(
            name='BallotMeasureSelection',
            fields=[
                ('ballotselectionbase_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='calaccess_processed.BallotSelectionBase')),
            ...
            bases=('calaccess_processed.ballotselectionbase',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('party', models.ForeignKey(help_text='If the contest is among candidates of the same political party, e.g., a partisan primary election, reference to the OCD ``Party`` representing that political party.', null=True, on_delete=django.db.models.deletion.CASCADE, to='calaccess_processed.Party')),
            ],
            options={
                'ordering': ('election', 'name'),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contest', models.ForeignKey(help_text='References the ``CandidateContest`` in which the selection is an option.', on_delete=django.db.models.deletion.CASCADE, related_name='ballot_selections', to='calaccess_processed.CandidateContest')),
                ('endorsement_parties', models.ManyToManyField(help_text='Each ``Party`` that is endorsing the candidates associated with the selection. The number of parties is unbounded in cases where multiple parties endorse a single candidate/ticket.', to='calaccess_processed.Party')),
            ],
            options={
                'ordering': ('contest',),
            },
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(help_text='Reference to the OCD ``Organization`` that administers the election.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='elections', to='opencivicdata.Organization'),
        ),
        migrations.AddField(
            model_name='contestsource',
            name='contest',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sources', to='calaccess_processed.ContestBase'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='division',
            field=models.ForeignKey(help_text='Reference to the OCD ``Division`` that defines the geographical scope of the contest, e.g., a specific Congressional or State Senate district.', on_delete=django.db.models.deletion.CASCADE, related_name='divisions', to='opencivicdata.Division'),
        ),
        migrations.AddField(
            model_name='contestbase',
            name='election',
        ...
        migrations.AddField(
            model_name='candidacy',
            name='person',
            field=models.ForeignKey(help_text='Reference to an OCD ``Person`` who is the candidate.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='candidacies', to='opencivicdata.Person'),
        ),
        migrations.AddField(
            model_name='candidacy',
            name='post',
            field=models.ForeignKey(help_text='References the ``Post`` that represents the public office for which the candidate is competing.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='candidates', to='opencivicdata.Post'),
        ),
        migrations.AddField(
            model_name='ballotselectionsource',
            name='ballot_selection',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sources', to='calaccess_processed.BallotSelectionBase'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='posts',
            field=models.ManyToManyField(help_text='References to the OCD ``Post`` representing the public offices for which the candidates are competing. If multiple, the primary post should be listed first, e.g., the id for the President post should be listed before the id for Vice-President.', to='opencivicdata.Post'),
        ),
        migrations.AddField(
            model_name='candidatecontest',
        ...
        migrations.AddField(
            ...
            name='membership',
            field=models.ForeignKey(help_text='Reference to the OCD ``Membership`` that represents the tenure of a particular person (i.e., OCD ``Person`` object) in a particular public office (i.e., ``Post`` object).', on_delete=django.db.models.deletion.CASCADE, to='opencivicdata.Membership'),
        ),
    ]
