# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-11-28 18:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('treasurer_state', models.CharField(blank=True, help_text="State of the lender committee's treasurer (from LOAN_CD.TRES_ST)", max_length=2, verbose_name='treasurer state')),
                ('treasurer_zip', models.CharField(blank=True, help_text="Zip code (usually zip5, sometimes zip9) of the lender committee's treasurer (from LOAN_CD.TRES_ZIP4)", max_length=10, verbose_name='treasurer zip')),
                ('date_paid_or_forgiven', models.DateField(help_text='Date when the loan repayment or forgiveness occurred (from LOAN_CD.LOAN_DATE2)', null=True, verbose_name='date paid or forgiven')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient_occupation', models.CharField(blank=True, help_text='Occupation of the recipient (from LOAN_CD.LOAN_OCC)', max_length=60, verbose_name='recipient occupation')),
