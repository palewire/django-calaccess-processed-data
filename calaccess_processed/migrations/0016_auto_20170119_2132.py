# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-01-19 21:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Time that this object was last updated in the system.')),
                ('extras', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, help_text='Common to all Open Civic Data types, the value is a key-value store suitable for storing arbitrary information not covered elsewhere.')),
                ('id', calaccess_processed.models.opencivicdata.base.OCDIDField(ocd_type='jurisdiction', serialize=False, validators=[django.core.validators.RegexValidator(flags=32, message='ID must match ^ocd-jurisdiction/country:[a-z]{2}(/[^\\W\\d]+:[\\w.~-]+)*/\\w+$', regex=b'^ocd-jurisdiction/country:[a-z]{2}(/[^\\W\\d]+:[\\w.~-]+)*/\\w+$')])),
                ('name', models.CharField(max_length=300)),
                ('url', models.URLField(max_length=2000)),
                ('classification', models.CharField(choices=[(b'government', b'Government'), (b'legislature', b'Legislature'), (b'executive', b'Executive'), (b'school_system', b'School System'), (b'transit_authority', b'Transit Authority')], db_index=True, default='government', max_length=50)),
